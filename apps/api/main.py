...
from routers import attempts, cards, dashboard, diagnosis, energy, export as export_router, institution, language, mock, privacy, profiles, provenance, question_banks, resources, review, study_plan, todos, transfer, waves
