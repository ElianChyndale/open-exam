...
next_drill: 24 小时内重做 2 道 Quantitative Methods / M08 Hypothesis Testing - paired comparisons
  test (exact LOS not shown) 同类题。
review_due_at: 2026-05-27
linked_patterns: null
correct_resolution: A. rejected because the computed test statistic exceeds 2.807.
  For paired observations, use t = (mean difference - hypothesized difference) / (sample
  standard deviation of differences / sqrt(n)) = (4.25 - 0) / (6.25 / sqrt(25)) =
  3.40. Since 3.40 > 2.807, reject H0.
