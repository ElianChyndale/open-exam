...
next_drill: 24 小时内重做 2 道 Quantitative Methods / M08 Hypothesis Testing - nonparametric
  tests (exact LOS not shown) 同类题。
review_due_at: 2026-05-27
linked_patterns: null
correct_resolution: A. data consist of ranked values. Nonparametric tests are most
  appropriate for ranked or ordinal data; they are used when parametric-test assumptions
  are not appropriate.
