...
DEFAULT_FEATURE_FLAGS: dict[str, bool] = {
    ...
    "tutor_analysis_enabled": False,
    "skill_reflection_enabled": False,
    "skill_upgrade_proposals_enabled": False,
    "skill_codex_task_generator_enabled": False,
    "codex_self_loop_enabled": False,
