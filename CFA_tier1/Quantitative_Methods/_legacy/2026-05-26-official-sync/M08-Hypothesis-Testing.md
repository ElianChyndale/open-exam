...
description: 假设检验 — H0/H1, Type I/II, p-value, 置信区间, pooled/unpooled t-test, F-test for variances, chi-square test for variance, paired comparisons test, 参数与非参数检验
module: M08
