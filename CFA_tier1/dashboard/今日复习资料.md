...
### 6. Quantitative Methods | M08 Hypothesis Testing - nonparametric tests (exact LOS not shown) | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-27；近期低信心 2026-05-26
...
### 7. Quantitative Methods | M08 Hypothesis Testing - paired comparisons test (exact LOS not shown) | formula_misuse
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-27；近期低信心 2026-05-26
...
### 8. Economics | M02 Understanding Business Cycles - economic indicators over the business cycle: leading vs lagging indicators (approximate from screenshot) | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-27
...
### 9. Economics | M02 Understanding Business Cycles - resource use and labor productivity over the business cycle (approximate from screenshot) | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-27
...
### 10. Economics | M03 Fiscal Policy - compare monetary and fiscal policy; fiscal policy scope (approximate from screenshot) | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-27
...
### 11. Economics | M04 Monetary Policy - limitations of monetary policy; least likely limitation (approximate from screenshot) | prompt_misread
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-27
...
### 12. Economics | M04 Monetary Policy - quantitative easing and environments where monetary policy is effective (approximate from screenshot) | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-27
...
### 13. Economics | M08: Exchange Rate Calculations — exchange rate depreciation/appreciation asymmetry | formula_misuse
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28
...
#### 正确理解 / 解法
> C. More than 12 percent. [1/(1 - 0.12)] - 1 = 1/0.88 - 1 = 0.1364 = 13.64%. GBP appreciated more than 12% because the base currency changes — depreciation and appreciation are not symmetric.

#### 下次规则
- **纠偏规则：** 汇率涨跌不对称：A 对 B 贬值 x%，不等于 B 对 A 升值 x%。升值比例 = 1/(1 - x) - 1。
- **下一步练习：** 24 小时内重做 2 道 Economics / M08 Exchange Rate Calculations 同类题。
- **证据：** memory cache
...
#### 正确理解 / 解法
> B. 1.3426. 1.4500 / X = 1.08 → X = 1.4500 / 1.08 = 1.3426. Base currency appreciation means the new rate = old rate × (1 + appreciation rate), so solve for old rate by dividing.

#### 下次规则
- **纠偏规则：** 汇率 = price currency / base currency。base currency 在分母，升值 8% 意味着分数值提高 8% → new = old × (1+r) → old = new / (1+r)。不要把 base 当成分子去乘。
- **下一步练习：** 24 小时内重做 2 道 Economics / M08 Exchange Rate Calculations 同类题。
- **证据：** memory cache

### 15. Portfolio Management | unknown_from_screenshot | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
...
#### 正确理解 / 解法
> 正确答案是 C。题目考的是 overfitting：ML 模型把 training data 学得过于精确，把噪音也当成真实参数，导致换一个 dataset 后预测反而不准。black box 不是因为 data biases 才被称为 black box；A 的因果关系不成立。

#### 下次规则
- **纠偏规则：** 先写出考点定义，再用一句话说明为什么正确选项成立。
- **下一步练习：** 24 小时内重做 2 道 Portfolio Management / unknown_from_screenshot 同类题。
- **证据：** chat-screenshot-2026-05-25-ml-overfitting

### 16. Quantitative Methods | unknown_from_screenshot | prompt_misread
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-25
...
#### 正确理解 / 解法
> 正确答案是 C. a more representative sample。题干比较的是 probability sampling 相对于 non-probability sampling 的结果：probability sampling 给总体成员更均等的被抽中机会，因此通常更具代表性、更准确、更可靠。

#### 下次规则
- **纠偏规则：** 把错误转成一句可重复执行的纠偏规则。
- **下一步练习：** 24 小时内重做 2 道 Quantitative Methods / unknown_from_screenshot 同类题。
- **证据：** chat-screenshot-2026-05-25-probability-sampling-misread

### 17. Quantitative Methods | unknown_from_screenshot | formula_misuse
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-25
...
#### 正确理解 / 解法
> 若收益率按小数表示，则 target 2% 必须写成 0.02。低于 2% 的回报分别用 (0.015-0.02)^2、(-0.02-0.02)^2、(0-0.02)^2，合计 0.002025，再按题目口径开方得到 1.50%。核心不是公式变了，而是 percent 与 decimal 必须全程统一单位。

#### 下次规则
- **纠偏规则：** 先画结构或时间轴，再代入公式或计算器。
- **下一步练习：** 24 小时内重做 2 道 Quantitative Methods / unknown_from_screenshot 同类题。
- **证据：** chat-screenshot-2026-05-25-target-semideviation

### 18. Quantitative Methods | unknown_from_user_note | concept_confusion
- **先遮答案想：** 这题真正考的 trigger 是什么？我上次为什么会错？
- **今天为什么看：** 到期复习 2026-05-28；近期低信心 2026-05-25
...
#### 正确理解 / 解法
> 偏度图本质是在展示数据分布形状。y 轴表示 frequency（频率），x 轴表示变量取值或收益结果；判断左偏/右偏时先看尾巴方向，但读图前先锁定坐标轴含义。
