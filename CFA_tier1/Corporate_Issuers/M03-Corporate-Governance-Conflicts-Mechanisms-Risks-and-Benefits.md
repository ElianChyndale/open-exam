...
### 3.1 学习任务
- **核心问题**：考试希望你用 `Corporate Governance: Conflicts, Mechanisms, Risks, and Benefits` 解释什么、计算什么、或判断什么。
...
|---|---|---|---|
| 3.1 | describe the principal-agent relationship and conflicts that may arise between stakeholder groups | 描述定义、流程和适用场景 | 写出结论、依据和限制条件。 |
| 3.2 | describe corporate governance and mechanisms to manage stakeholder relationships and mitigate associated risks | 描述定义、流程和适用场景 | 写出结论、依据和限制条件。 |
| 3.3 | describe potential risks of poor corporate governance and stakeholder management and benefits of effective corporate governance and stakeholder management | 描述定义、流程和适用场景 | 写出结论、依据和限制条件。 |
...
├─ 3.2 Stakeholder Conflicts and Management
...
├─ 3.4 Corporate Governance Risks and Benefits
...
- **对应 LOS 动作**：描述定义、流程和适用场景；官方表述为：`describe the principal-agent relationship and conflicts that may arise between stakeholder groups`。
- **核心词汇**：**Corporate Governance: Conflicts, Mechanisms, Risks, and Benefits（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **解题输出**：用一句话写出结论，再补充计算口径、方向判断或限制条件，避免只背定义。

### 3.2 Stakeholder Conflicts and Management
- **中文主线**：本节点解决 `Stakeholder Conflicts and Management` 在 Corporate Issuers 中的定义、适用条件和考试判断。先确认题干问的是概念识别、机制解释、数值计算还是优劣比较。
- **对应 LOS 动作**：描述定义、流程和适用场景；官方表述为：`describe corporate governance and mechanisms to manage stakeholder relationships and mitigate associated risks`。
- **核心词汇**：**Corporate Governance（公司治理）**：约束管理层、董事会和股东之间权责关系的制度。
- **解题输出**：用一句话写出结论，再补充计算口径、方向判断或限制条件，避免只背定义。

### 3.3 Corporate Governance Mechanisms
- **中文主线**：本节点解决 `Corporate Governance Mechanisms` 在 Corporate Issuers 中的定义、适用条件和考试判断。先确认题干问的是概念识别、机制解释、数值计算还是优劣比较。
- **对应 LOS 动作**：描述定义、流程和适用场景；官方表述为：`describe potential risks of poor corporate governance and stakeholder management and benefits of effective corporate governance and stakeholder management`。
- **核心词汇**：**Introduction（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **解题输出**：用一句话写出结论，再补充计算口径、方向判断或限制条件，避免只背定义。

### 3.4 Corporate Governance Risks and Benefits
- **中文主线**：本节点解决 `Corporate Governance Risks and Benefits` 在 Corporate Issuers 中的定义、适用条件和考试判断。先确认题干问的是概念识别、机制解释、数值计算还是优劣比较。
- **对应 LOS 动作**：描述定义、流程和适用场景；官方表述为：`describe the principal-agent relationship and conflicts that may arise between stakeholder groups`。
- **核心词汇**：**Stakeholder Conflicts and Management（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **解题输出**：用一句话写出结论，再补充计算口径、方向判断或限制条件，避免只背定义。


## 5. 关键公式与计算框架

本模块以概念判断为主，无核心计算公式。复习时把 `Corporate Governance: Conflicts, Mechanisms, Risks, and Benefits` 的定义、触发条件、优缺点和例外情形整理成判断清单。
...
- **中英文错配**：看到 `Corporate Governance: Conflicts, Mechanisms, Risks, and Benefits` 相关英文词，不要只按中文直觉判断，先回到官方定义。
...
- **上游模块**：[[M02-Investors-and-Other-Stakeholders]]。它提供本模块所需的定义、变量或基础框架。
- **下游模块**：[[M04-Working-Capital-and-Liquidity]]。它通常会把本模块工具用于更复杂的估值、风险或情境判断。
...
本次未发现可直接高置信合并的 legacy 内容。中置信候选已记录到 enrichment map：`M02-Corporate-Governance-and-ESG.md` (0.406), `M02-Investors-and-Other-Stakeholders.md` (0.394), `00-Corporate-Issuers-MOC.md` (0.361)。后续如需人工补强，应先核验其是否符合 2026 官方 LOS。
