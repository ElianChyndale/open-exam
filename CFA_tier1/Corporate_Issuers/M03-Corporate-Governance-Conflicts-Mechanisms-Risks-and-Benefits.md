...
- **Official scope**: principal-agent relationship, stakeholder conflicts, governance mechanisms, risks and benefits of governance.
- **C+ output**: 能从 conflict 选择 mechanism，并解释 operational, legal/reputational or financial impact。
- **Evidence anchor**: V3 Module 3, practice and solutions available in the 2026 ePub index.

## 1. Module Brief 模块定位

Governance is the control system around corporate power. 考试重点不是背机制名称，而是把机制匹配到 conflict and risk。

## 2. Curriculum Spine 教材主线

1. Stakeholder conflicts: shareholder-board-manager, controlling-minority shareholder, shareholder-creditor.
2. Reporting and transparency.
3. Shareholder mechanisms: meetings, activism, litigation, takeovers.
4. Creditor mechanisms: bond indenture, creditor committees.
5. Board/management mechanisms: audit, nomination/governance, compensation and other committees.
6. Employee, customer, supplier and government mechanisms.
7. Risks/benefits: operational, legal/regulatory/reputational, financial.
...
- `compensation committee` -> align management incentives.

## 4. Formula & Decision Bench 公式与决策台

| Trigger | Governance mechanism | Check |
|---|---|---|
| Principal-agent | monitoring, incentives, independent board | Align agent with principal. |
| Controlling vs minority | voting rights, disclosure, litigation, board independence | Protect minority shareholders. |
| Shareholder vs creditor | covenants, indentures, creditor committees | Limit risk shifting and payouts. |
...
- Review tag: `Corporate-M03-governance`.
- Miss log fields: conflict pair, mechanism, committee, risk type, value impact.

## 6. Trap Ledger 易错账本

- Governance mechanisms are not interchangeable; each targets a specific conflict。
...
- Conflict first, mechanism second.
