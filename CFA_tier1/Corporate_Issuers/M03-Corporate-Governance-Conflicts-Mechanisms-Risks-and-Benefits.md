...
description: "CFA Level I 2026 official module: Corporate Governance: Conflicts, Mechanisms, Risks, and Benefits"
module: M03
...
### Migrated from `CFA_tier1/Corporate_Issuers/M02-Corporate-Governance-and-ESG.md`

_Alignment score: 1.00. Original official module field: Module 3: Corporate Governance: Conflicts, Mechanisms, Risks, and Benefits._

#### M03: Corporate Governance and ESG（公司治理与 ESG）

##### 1. 核心知识点

###### 1.1 代理架构 (Agency Architecture)
...
###### 1.2 ESG 与受托责任 (ESG and Stewardship)
...
- **治理不是表面文章**：良好的治理不仅仅是合规和文书，它真正影响决策质量和折现率。
- **ESG 不等于"好人好事"**：考试关注的是**实质性 (materiality)** — 哪些 ESG 因素真的影响财务表现。
- **独立董事 ≠ 外部董事**：独立董事必须与公司没有重大业务或个人关系，而外部董事仅指不在公司任职。
- **代理问题不仅存在于股东-管理层之间**：控股股东与小股东之间（隧道效应 tunneling）、股东与债权人之间也存在代理冲突。
