...
> **一句话核心**：Corporate Issuers 解释公司如何组织、治理、融资、投资、管理流动性，并把这些选择转成 value creation or value destruction。

## 1. Subject Brief 科目定位

- **Exam role**: 6-9% 权重，题目常把定性治理与定量资本配置混合考。
- **Core question**: `How do issuer decisions affect risk, cash flow timing, financing cost, and stakeholder value?`
- **Learning path**: M01-M03 建立 ownership/governance；M04 管理 liquidity；M05-M06 判断 investment and financing decisions；M07 识别 business model economics。
- **Output standard**: 每道题都要落到 `claim/stakeholder -> conflict or metric -> decision rule -> value implication`。
...
### E. Capital Investments / Capital Allocation
...
### F. Cost of Capital / Capital Structure / Lifecycle
...
|---|---|---|
| [[M01-Organizational-Forms-Corporate-Issuer-Features-and-Ownership]] | Organizational forms, issuer features, public/private ownership | legal form determines liability, capital access, control and disclosure。 |
| [[M02-Investors-and-Other-Stakeholders]] | Debt/equity claims, stakeholder groups, ESG | claim priority and motivation explain conflicts。 |
| [[M03-Corporate-Governance-Conflicts-Mechanisms-Risks-and-Benefits]] | Conflicts, mechanisms, risks, benefits | governance is conflict-control architecture。 |
| [[M04-Working-Capital-and-Liquidity]] | CCC, liquidity ratios, working capital methods | liquidity is timing and funding flexibility。 |
| [[M05-Capital-Investments-and-Capital-Allocation]] | Project types, NPV/IRR/ROIC, pitfalls, real options | capital allocation should maximize value under constraints。 |
| [[M06-Capital-Structure]] | WACC, capital structure factors, MM, target structure | financing mix changes risk, tax shield and cost of capital。 |
| [[M07-Business-Models]] | business model features and types | model economics drive revenue quality, margins and capital needs。 |
...
5. **Investment decision**: classify project -> compute NPV/IRR/ROIC/PI/payback when relevant -> handle rationing and real options.
6. **Financing decision**: estimate WACC -> assess capital structure factors and lifecycle -> connect target weights to value.
7. **Business model economics**: identify customer/offering/channel/pricing -> infer revenue stability, scalability, margins and funding needs.

## 5. Exam Routes 做题路线

- **Governance route**: stakeholder pair -> conflict -> mechanism -> risk/benefit -> effect on cost of capital or value.
...
- Source evidence: 2026 official registry and ePub index show end-of-reading practice available for M01-M07.
- **High calculation evidence**: M04 CCC/liquidity ratios, M05 NPV/IRR/ROIC/PI/payback, M06 WACC and leverage direction.
- **High judgment evidence**: M01 public/private and organizational form, M02 debt/equity conflicts, M03 governance mechanisms, M07 revenue/pricing models.
- **Mock review tag rule**: tag every miss as `organizational form`, `claim priority`, `stakeholder conflict`, `governance mechanism`, `liquidity timing`, `capital allocation`, `capital structure`, or `business model`。

## 7. Review Routes 复习路线

- **Fast route 45-60 min**: CCC and liquidity formulas -> NPV/IRR/PI/payback -> WACC -> governance conflict map.
- **Deep route half day**: M01-M03 governance architecture -> M04 liquidity -> M05 capital allocation -> M06 financing -> M07 business model economics.
- **Error route**: if formula error, rebuild timeline/weights; if concept error, write stakeholder pair; if decision error, state value implication in one sentence.
- **Pre-mock route**: rehearse debt vs equity, shareholder vs creditor conflicts, DIO/DSO/DPO, NPV vs IRR, after-tax debt, market weights, subscription vs transaction revenue。

## 8. Cross-Subject Interfaces 跨科目接口

| Interface | Link | Why it matters |
|---|---|---|
| Equity | company analysis, forecasting, valuation, business model and capital structure | issuer decisions feed equity value and required return。 |
| Financial Statement Analysis | working capital, liquidity, profitability, ROIC, debt metrics | ratios and cash-flow quality supply Corporate Issuers evidence。 |
| Quantitative Methods | TVM, return measures, discounting, scenario thinking | NPV, IRR and WACC calculations require discount-rate discipline。 |
| Economics | business cycles, market structure, macro rates, regulation | top-down factors affect capital structure and revenue models。 |
| Fixed Income | debt claims, covenants, credit risk, cost of debt | creditor mechanisms and leverage depend on bondholder protection。 |
| Portfolio Management | ESG, governance risk, investor objectives | governance and stakeholder quality affect investment suitability and risk。 |
