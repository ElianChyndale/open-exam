...
> **模块定位**：用 Code and Standards 判断专业行为、利益冲突、客户责任与合规边界。 本模块聚焦 **Introduction to the Global Investment Performance Standards (GIPS)**，要求把官方 LOS 转成可执行的判断、计算或解释动作。
...
- **Why Were the GIPS Standards Created, Who Can Claim Compliance, & Who（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Composites（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Fundamentals of Compliance（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Verification（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
