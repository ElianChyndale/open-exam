...
### 外汇市场参与者（FX Market Participants）
...
- **贸易逆差 alone 不能解释汇率走势**：资本流动、利差、预期和政策变化都可能主导汇率方向。
- **经常账户 vs 金融账户的区分**：经常账户记录收入和支出流；金融账户记录资产和负债的变化。股票投资和债券投资属于金融账户。
- **储备资产（reserve assets）**是金融账户的一个子项，反映央行持有的外汇储备变动。
- **三元悖论必考**：固定汇率、资本自由流动、独立货币政策三者只能选其二。
