...
> **模块定位**：从债券现金流、收益率曲线、久期凸性、信用和证券化拆解固定收益风险回报。 本模块聚焦 **Yield-Based Bond Convexity and Portfolio Properties**，要求把官方 LOS 转成可执行的判断、计算或解释动作。
...
### 12.1 学习任务
- **核心问题**：考试希望你用 `Yield-Based Bond Convexity and Portfolio Properties` 解释什么、计算什么、比较什么，或判断什么。
...
### 12.3 关键英文术语
- **Yield-Based Bond Convexity and Portfolio Properties（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Introduction（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Bond Convexity and Convexity Adjustment（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Bond Risk and Return Using Duration and Convexity（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Portfolio Duration and Convexity（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
...
|---|---|---|---|
| 12.1 | calculate and interpret convexity and describe the convexity adjustment | 计算并解释数值结果；解释结果的投资含义；描述定义、流程和适用场景 | 写出结论、依据、公式口径和限制条件。 |
| 12.2 | calculate the percentage price change of a bond for a specified change in yield, given the bond’s duration and convexity | 计算并解释数值结果 | 写出结论、依据、公式口径和限制条件。 |
| 12.3 | calculate portfolio duration and convexity and explain the limitations of these measures | 计算并解释数值结果；解释机制、原因和后果 | 写出结论、依据、公式口径和限制条件。 |
...
| ⭐⭐⭐ | 12.2 Bond Convexity and Convexity Adjustment | 先定位题干触发词，再写公式/框架，最后解释结果或判断陷阱。 |
| ⭐⭐ | 12.3 Bond Risk and Return Using Duration and Convexity | 先定位题干触发词，再写公式/框架，最后解释结果或判断陷阱。 |
| ⭐⭐ | 12.4 Portfolio Duration and Convexity | 先定位题干触发词，再写公式/框架，最后解释结果或判断陷阱。 |
...
- **主要 legacy 来源**：`M08-Duration-and-Convexity.md` (high, 0.482)
