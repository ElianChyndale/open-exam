...
> **模块定位**：用无套利、复制和工具结构理解远期、期货、互换、期权的风险转移。 本模块聚焦 **Valuing a Derivative Using a One-Period Binomial Model**，要求把官方 LOS 转成可执行的判断、计算或解释动作。
...
### 10.1 学习任务
- **核心问题**：考试希望你用 `Valuing a Derivative Using a One-Period Binomial Model` 解释什么、计算什么、比较什么，或判断什么。
...
### 10.3 关键英文术语
- **Valuing a Derivative Using a One-Period Binomial Model（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Introduction（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Binomial Valuation（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **The Binomial Model（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Pricing a European Call Option（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
- **Risk Neutrality（核心术语）**：本模块关键词，用于定位 LOS、题干条件和解题动作。
...
|---|---|---|---|
| 10.1 | explain how to value a derivative using a one-period binomial model | 解释机制、原因和后果 | 写出结论、依据、公式口径和限制条件。 |
| 10.2 | describe the concept of risk neutrality in derivatives pricing | 描述定义、流程和适用场景 | 写出结论、依据、公式口径和限制条件。 |
...
- **中文主线**：围绕 `Binomial Valuation` 掌握定义、适用条件、公式/框架和考试判断。
- **对应动作**：描述定义、流程和适用场景

### 10.3 The Binomial Model

- **中文主线**：围绕 `The Binomial Model` 掌握定义、适用条件、公式/框架和考试判断。
- **对应动作**：识别概念并应用到题干。

### 10.4 Pricing a European Call Option

- **中文主线**：围绕 `Pricing a European Call Option` 掌握定义、适用条件、公式/框架和考试判断。
- **对应动作**：识别概念并应用到题干。
...
| ⭐⭐⭐ | 10.2 Binomial Valuation | 先定位题干触发词，再写公式/框架，最后解释结果或判断陷阱。 |
| ⭐⭐ | 10.3 The Binomial Model | 先定位题干触发词，再写公式/框架，最后解释结果或判断陷阱。 |
...
- **主要 legacy 来源**：`00-Derivatives-MOC.md` (high, 0.622)
