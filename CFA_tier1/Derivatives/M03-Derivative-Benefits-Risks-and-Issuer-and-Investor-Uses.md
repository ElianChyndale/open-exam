...
### Migrated from `CFA_tier1/Derivatives/M03-Benefits-and-Risks.md`

_Alignment score: 0.40. Original official module field: Derivative Benefits/Risks/Uses._
...
- 对冲降低的是特定风险，可能引入新的风险类型 (basis, counterparty)
- 杠杆是双刃剑：放大收益也放大损失
- 衍生品用于**风险转移**而非风险消灭 (risk transfer, not risk elimination)
